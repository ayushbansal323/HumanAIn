...
def main():	
	...
	for name_id,dataset_id in dataset_group_id:
		...
		for i in range(0,len(prediction)):
			hour_temp_score = prediction[i][0][0]
			hour_temp_name = name_id
			#print(hour_temp_score)
			#print(top_3_24hour_kwh[0][0])
			for j in range(0,3):
